...
.media-wrapper .media-youtube iframe {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.media-wrapper .media-audio .vjs-default-skin .vjs-current-time,
.media-wrapper .media-audio .vjs-default-skin .vjs-remaining-time {
  right: 50px;
}
.media-wrapper .media-audio .vjs-default-skin .vjs-duration {
  right: 0;
}
.media-wrapper .media-audio .vjs-default-skin .vjs-time-divider {
  right: 45px;
}
.media-wrapper .media-audio .vjs-default-skin .vjs-fullscreen-control {
  display: none;
}
.media-wrapper .media-audio .vjs-default-skin .vjs-big-play-button:before {
  content: "\e006";
}
